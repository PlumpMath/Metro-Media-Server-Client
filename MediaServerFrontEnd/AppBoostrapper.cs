...
namespace MediaServerFrontEnd
{
    public class AppBoostrapper : Bootstrapper<MainWindowViewModel>
    {
        ...
        private void SetupDesignMode()
        {
            ...
            //builder.Register<ClientConnector>(p => new ClientConnector("ws://192.168.1.21:8080/player")).SingleInstance();
